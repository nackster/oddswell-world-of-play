...
| Runtime | Unreal Engine 5.8.0 CL 55116800 | Pilot installed; editor reverified | Post-reboot no-project editor launch and normal exit passed without the prior runtime warning. Empty project, package, performance, replay, and permanent-adoption evidence remain pending. |
