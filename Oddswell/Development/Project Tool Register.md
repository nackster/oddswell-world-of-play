...
| Runtime | Unreal Engine 5.8.0 CL 55116800 | Primary; beta adopted | `client/OddsWell` reopens and packages reproducibly. The noncanonical block/court benchmark and authoritative recorded-replay renderer passed their gates. Phase 1B character onboarding also passed exit review for eight-option selection, native primitive third-person locomotion, separate replaceable starter clothing, and exact local appearance handoff/cold recovery. |
