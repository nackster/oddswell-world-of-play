...
| Runtime | Unreal Engine 5.8.0 CL 55116800 | Primary; beta adopted | `client/OddsWell` reopens and packages reproducibly. The noncanonical block/court benchmark, authoritative recorded-replay renderer, validated preset catalog, local eight-option selection screen, native primitive third-person locomotion, separate replaceable starter clothing, and local appearance save/handoff/cold-recovery path have passed their scoped evidence gates. |
