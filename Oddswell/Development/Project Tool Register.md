...
| Native build toolchain | Visual Studio 2022 + MSVC 14.44 + Windows SDK 10.0.22000.0 | Present; package compatibility pending | UE 5.8 launches, but its prerequisite check recommends Visual C++ Redistributable 14.50.35719.0 or newer instead of installed 14.44.35211.0. |
| Runtime | Unreal Engine 5.8.0 CL 55116800 | Pilot installed; editor verified | Local no-project editor launch and normal exit passed. Empty project, package, performance, replay, and permanent-adoption evidence remain pending. |
