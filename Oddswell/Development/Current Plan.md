...
- **Boundary and next gate:** this is review only. Scope Director review must select the next smallest truthful dependency. Normal confirmation/placement, correction, generalized player history, multiple requests, later markets, live odds, backend, deployment, retraining, simulator changes, and brain behavior remain separate unproved gates.
