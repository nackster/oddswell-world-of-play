...
- **Closed by Phase 1H.26S:** the exact pending Harbor/`40` request now schedules the existing H26G lock automatically at H26A tipoff. Simulation and H26H-H26P remain manual and separate.
...
- **Boundary and next gate:** H26S does not automatically create H26H-H26P, simulate, decide, settle, pay, refund, publish history, or catch up offline. Mesa placement, other stakes, generalized placement, multiple requests, correction, later markets, live odds, backend, deployment, retraining, simulator changes, and brain behavior remain separate unproved gates. Scope Director review chooses the next smallest dependency.
