...
- **Boundary and next gate:** Scope Director review must select the smallest truthful dependency after exact canonical loss history. Correction, broader player-visible history, multiple requests, later markets, backend, deployment, retraining, simulator changes, and brain behavior remain separate unproved gates.
