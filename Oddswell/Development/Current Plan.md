...
- **Boundary and next gate:** H26T does not create H26I-H26P, run simulation, produce a score, settle, publish history, repair evidence, generalize placement, add markets, change brains, add a backend, or deploy. Scope Director review may consider one automatic existing parameterless H26I digest-only handoff after durable H26H, with no automatic simulation or H26J-H26P chain.
