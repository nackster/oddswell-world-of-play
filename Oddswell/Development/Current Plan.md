...
- **Next candidate gate:** Scope Director review of the smallest remaining Phase 1H Match Winner evidence requirement. Winning read-only reconciliation/history is the nearest evidence gap; void/refund, correction, and player-facing history/UI remain separate unproved gates.
