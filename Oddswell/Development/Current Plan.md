...
- **Next candidate gate:** Scope Director review of the smallest remaining Match Winner requirement. Player-facing pending-request/history, a canonical future-game route, lock/settlement integration, and correction remain separate unproved gates; Phase 1H.18 has not begun.
