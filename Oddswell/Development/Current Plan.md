...
- **Boundary and next gate:** Scope Director review must select the smallest truthful dependency after the exact player settled-loss receipt. Correction, generalized player history, multiple requests, later markets, backend, deployment, retraining, simulator changes, and brain behavior remain separate unproved gates.
