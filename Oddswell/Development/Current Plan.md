...
- **Boundary and next gate:** this does not auto-lock, simulate, decide, settle, pay, refund, or publish history. Mesa placement, other stakes, multiple requests, generalized submission, correction, later markets, live odds, backend, deployment, retraining, simulator changes, and brain behavior remain separate unproved gates. Scope Director review chooses the next smallest dependency.
