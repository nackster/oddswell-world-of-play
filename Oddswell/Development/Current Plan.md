...
- **Next candidate gate:** Scope Director review of a read-only reconciliation/history view for the finalized exact loss versus another required Phase 1H evidence gate. This is a candidate comparison only and authorizes neither option.
