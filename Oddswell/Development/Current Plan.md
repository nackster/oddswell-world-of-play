...
- **Next gate:** Phase 1G.5 should expose truthful read-only ledger and next-job-eligibility reconciliation in Brain Admin without granting commands or claiming backend/account authority.
