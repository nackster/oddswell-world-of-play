...
- **Boundary and next gate:** Scope Director review must select the smallest truthful dependency after exact loss finalization. Application/history, correction, multiple requests, player-visible settlement, later markets, backend, deployment, retraining, simulator changes, and brain behavior remain unproved and unauthorized.
