...
- **Boundary and next gate:** H26Z proves one explicit isolated link only. The next Scope Director review may consider only whether one separate H26M decision invocation is the smallest truthful next proof; no automatic H26L–H26P chain is authorized.
