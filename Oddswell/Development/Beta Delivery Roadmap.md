...
- Phase 1H.16 player-facing exact offer preview: **COMPLETE AT THE SEPARATE SUNDALE SPORTSBOOK FRONTAGE ONLY**; see [[Development/Reports/Phase 1H16 Player Facing Match Winner Offer Preview]]. The exact canonical Season 1, Game 1 offer is visible read-only at that location without wager submission or ledger mutation.
- Next gate: **SCOPE DIRECTOR REVIEW** of the smallest remaining Match Winner requirement. Player wager submission, player-facing history, correction, and later markets remain separate unproved and unauthorized gates; Phase 1H.17 has not begun. Sundale remains a working name.
...
| 8 | 1H — Wager locking and settlement | Place approved wagers and receive exact outcomes | ACTIVE — LOSS + WIN + CANCELED QA FINALIZED/HISTORY PROOF + READ-ONLY PLAYER OFFER PREVIEW / SUBMISSION, PLAYER HISTORY, AND CORRECTION UNPROVEN |
...
- **1H.16 COMPLETE — PLAYER-FACING EXACT OFFER PREVIEW ONLY:** at the separate Sundale Sportsbook frontage, `E` opens the exact canonical Season 1, Game 1 offer with teams, probabilities, odds, stake bounds, game-start lock, gross-return examples, offer ID, source versions, and commitment. It closes outside the frontage; strict independent validation fails closed; packaged proof leaves ledger count and balance unchanged. See [[Development/Reports/Phase 1H16 Player Facing Match Winner Offer Preview]].
- **NEXT GATE:** Scope Director review of the smallest remaining Match Winner requirement. Player wager submission, player-facing history, correction, later markets, backend, and brain work remain separate unproved and unauthorized gates; Phase 1H.17 has not begun.
