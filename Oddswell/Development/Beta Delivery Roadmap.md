...
- **NEXT GATE:** fresh Scope Director review before any further implementation. A normal Mesa wager route changes the player economy and needs a separate owner-approved gate. Generalized history, multiple wagers, correction, later markets, online authority, backend, or brain/simulator work remains separate and unproved.
