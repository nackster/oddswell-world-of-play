...
- **NEXT CANDIDATE FOR SCOPE DIRECTOR REVIEW ONLY:** compare a read-only reconciliation/history view of the finalized exact loss with another remaining Phase 1H evidence gate. This roadmap update authorizes neither candidate and does not authorize winning payout, refund, void, correction, UI, Admin mutation, props, backend, or brain work.
