...
- Next gate: **PHASE 1J.3b.1b ONE-PARTICIPANT OBSERVED COMPREHENSION SESSION**. The owner approved one initial uncoached participant. Run the unseen equivalent form once, record the six responses and concept-level misses only after completion, and do not reopen a brain unless the measured gap cannot be represented by current public evidence.
...
| 10 | 1J — Athlete life and league storytelling | Understand athletes, availability, and consequences | ACTIVE — 1J.1 STORIES + 1J.2 EXPLANATIONS + 1J.3a INSTRUMENT + 1J.3b.0 BLIND SESSION COMPLETE; HUMAN COMPREHENSION UNPROVEN |
...
6. **NEXT — 1J.3b.1b:** run the unseen form with the one owner-approved uncoached participant and record whether they distinguish ability, specialty, opportunity, form, context, and availability.
7. Reopen frozen brain scope only if first-playable testing identifies a named missing experience that existing fields cannot represent.
