...
- Next candidate gate: **SCOPE DIRECTOR REVIEW OF THE SMALLEST REMAINING PHASE 1H MATCH WINNER EVIDENCE REQUIREMENT**. Winning reconciliation/history is the nearest evidence gap; void/refund, correction, player-facing history/UI, and later markets remain unproved and unauthorized. Sundale remains a working name.
...
| 8 | 1H — Wager locking and settlement | Place approved wagers and receive exact outcomes | ACTIVE — EXACT LOSS FINALIZED/HISTORY + EXACT WIN APPLIED/FINALIZED / WIN HISTORY, VOID, CORRECTION, AND PLAYER UI UNPROVEN |
...
- **NEXT CANDIDATE FOR SCOPE DIRECTOR REVIEW ONLY:** select the smallest remaining Phase 1H Match Winner evidence requirement. Winning read-only reconciliation/history is the nearest evidence gap; void/refund, correction, player-facing history/UI, later markets, backend, and brain work remain unproved and unauthorized.
