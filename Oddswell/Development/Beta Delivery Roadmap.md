...
- Next gate: **SCOPE DIRECTOR REVIEW** of the smallest truthful dependency after exact loss finalization. Application/history, correction, broader history, multiple requests, and every later market remain unproved and unauthorized. Sundale remains a working name.
...
| 8 | 1H — Wager locking and settlement | Reach the physical booth, inspect approved odds, place approved wagers, and receive exact outcomes | ACTIVE — CANONICAL OFFER, ONE EXACT REQUEST/DEBIT, COLD PENDING RECEIPT, GAME-START LOCK, PRIVATE RESULT/LINK, AND EXACT LOSS DECISION + LOSS/WIN/PRIOR VOID HISTORY + EXACT NONCANONICAL QA REQUEST-TO-REFUND HISTORY COMPLETE / NORMAL SELECTION, FINALIZATION, CORRECTION, BROADER HISTORY, AND LATER MARKET PROOFS UNPROVEN |
...
- **NEXT GATE:** Scope Director review of the smallest truthful dependency after H26N exact loss finalization. Application/history, correction, broader player history, later markets, backend, and brain work remain separate unproved and unauthorized gates.
