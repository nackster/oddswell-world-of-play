...
- Next gate: **SCOPE DIRECTOR REVIEW** of the smallest server-owned canonical game-start lock for this exact request. Normal selection/confirmation, result, settlement, correction, broader history, multiple requests, and every later market remain unproved and unauthorized. Sundale remains a working name.
