...
- Next gate: **PHASE 1I.3 OWNED JACKET EQUIP AND SHARED-CITY VISIBILITY**. Let the owner explicitly equip the already-owned Signal Jacket in the one `outfit` slot and show it to one other local city client. Do not purchase again, auto-equip, add another garment, start furniture, or expand the catalog. Generalized wagers, online authority, later catalogs, and brain/simulator changes remain separate and unauthorized. Sundale remains a working name.
