...
- Next gate: **OWNER GATE — ONE FRESH UNSEEN AND UNCOACHED POST-CLARIFICATION SESSION**. Run it only when the owner confirms readiness. Do not reuse either retired form, coach the participant, or treat the prerequisite as comprehension evidence.
...
9. **OWNER GATE:** run one fresh unseen and uncoached post-clarification session only after the owner confirms readiness. Do not disclose the form, coach answers, or claim comprehension before observed evidence exists.
