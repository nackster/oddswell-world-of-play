...
- Next gate: **PHASE 1J.3b OBSERVED PLAYER COMPREHENSION PROOF**. Use the validated instrument with observed players and record whether they can make all six distinctions without developer coaching. Do not reopen a brain unless a named measured gap cannot be represented by current public evidence.
...
| 10 | 1J — Athlete life and league storytelling | Understand athletes, availability, and consequences | ACTIVE — 1J.1 STORIES + 1J.2 EXPLANATIONS + 1J.3a INSTRUMENT COMPLETE; HUMAN COMPREHENSION UNPROVEN |
...
4. **NEXT — 1J.3b:** run the validated instrument with observed players and record whether they distinguish ability, specialty, opportunity, form, context, and availability without coaching.
5. Reopen frozen brain scope only if first-playable testing identifies a named missing experience that existing fields cannot represent.
