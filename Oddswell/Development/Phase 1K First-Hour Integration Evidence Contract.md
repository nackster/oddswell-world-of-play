...
Phase 1K.4 may correct only the first failure measured by Phase 1K.3: normal packaged Bootstrap startup did not present the approved default character chooser. This document does not begin that correction or authorize auto-selection, route input, broader runtime work, configuration, or firewall changes.
