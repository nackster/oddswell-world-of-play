...
- **Status:** fresh technical component proof is **COMPLETE** in [[Development/Reports/Phase 1K6 Sundale Handoff Correction and Fresh Component One Proof]]; observed first-time-player usability remains unproved.
...
- **Status:** bounded individual proof exists in [[Development/Reports/Phase 1D1 Local Two-Client Shared City Presence]], [[Development/Reports/Phase 1D2 Replicated Appearance and Starter Clothing]], and [[Development/Reports/Phase 1D3 Cold Reconnect Visible State Restore]]. Fresh contiguous attempt [[Development/Reports/Phase 1K7 Normal Shared Session Membership Fail Fast Measurement]] **FAILED AT SHARED-SESSION MEMBERSHIP** before visibility, appearance agreement, or movement.
...
Phase 1K.7 measured the next normal boundary. One fresh owner repeated component 1, but its local `SundaleGraybox` browse created a separate standalone world instead of joining the waiting loopback listen server. The peer remained at `clients=1`; visibility, starter-appearance agreement, and movement were not reached. Component 1 remains **COMPLETE**, component 2 is incomplete at shared-session membership, and components 3-8 remain **NOT REACHED**.
...
| `phase1k5-20260805T173036Z` | 2026-08-05 | unchanged Phase 1K.4 Windows Development package; source baseline `d3ed222`; game executable SHA-256 `13E0E660CF5A086F74F408631F80FC51DCF77488DC8A87CF79D761E59B9E019B` | **PERSISTENCE PASSED; NORMAL WORLD HANDOFF FAILED; COMPONENTS 1-8 NOT REACHED** | one normal confirmation saved `masculine_tone_2` exactly once, then targeted absent `/Game/Maps/BlockCourtBenchmark`; `ClientTravelFailure` returned the owner to Bootstrap instead of required `SundaleGraybox` | [[Development/Reports/Phase 1K5 Fresh Non Default Preset Selection and Handoff Measurement]] |
| `phase1k6-20260805T235056Z` | 2026-08-05 | fresh Windows Development package; source baseline `727f418`; game executable SHA-256 `E9C6DE41A8A4391D7CE0C108FA12836E4B16DA19F1D420FDD84B617812CEF8F8` | **COMPONENT 1 PASSED; COMPONENTS 2-8 NOT REACHED** | no failure before the approved stop boundary: one Right and one Enter selected, saved, and handed non-default `masculine_tone_2` into normal `SundaleGraybox`; shared-session membership and movement were not attempted | [[Development/Reports/Phase 1K6 Sundale Handoff Correction and Fresh Component One Proof]] |
| `phase1k7-20260806T022019Z` | 2026-08-05 | unchanged Phase 1K.6 Windows Development package; commit `b060027`; game executable SHA-256 `E9C6DE41A8A4391D7CE0C108FA12836E4B16DA19F1D420FDD84B617812CEF8F8` | **COMPONENT 1 PASSED; COMPONENT 2 FAILED AT SHARED-SESSION MEMBERSHIP; COMPONENTS 3-8 NOT REACHED** | the normal owner opened a separate local Sundale world; the waiting peer stayed at `clients=1`, so mutual visibility, appearance agreement, and movement were not attempted | [[Development/Reports/Phase 1K7 Normal Shared Session Membership Fail Fast Measurement]] |
