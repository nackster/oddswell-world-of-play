...
- Phase 1C.0 produced three noncanonical grounded modern-day comparison packages in [[Design/First City Concept Packages]], but Phase 1C remains stopped at its owner gate. No package, first-city identity, graybox, apartment, Odds Bucks ledger, wager settlement, clothing store, or furniture store is complete or canonical merely because it appears in this beta plan; city implementation waits for explicit owner selection or approval of a named hybrid.
