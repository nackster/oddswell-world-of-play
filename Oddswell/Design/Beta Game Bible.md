...
- Phase 1H.1 freezes the first Match Winner rules, Phase 1H.2 implements the offer contract, Phase 1H.3 persists one machine-local accepted request plus stake debit, and Phase 1H.4 persists one separate idempotent game-start lock decision in [[Development/Reports/Phase 1H4 Idempotent Match Winner Game Start Lock]]. No player-facing wager route, result consumption, settlement, prop market, or wager Admin view is implemented.
