...
ODDSWELL_API const FString& GetOddsWellSignalJacketItemId();
ODDSWELL_API int64 GetOddsWellSignalJacketPrice();
ODDSWELL_API EOddsWellOddsBucksAppendResult AppendOddsWellSignalJacketPurchase(FOddsWellOddsBucksLedger& Ledger);
ODDSWELL_API bool OwnsOddsWellSignalJacket(const FOddsWellOddsBucksLedger& Ledger);
ODDSWELL_API const FString& GetOddsWellModularChairItemId();
ODDSWELL_API int64 GetOddsWellModularChairPrice();
ODDSWELL_API EOddsWellOddsBucksAppendResult AppendOddsWellModularChairPurchase(FOddsWellOddsBucksLedger& Ledger);
ODDSWELL_API bool OwnsOddsWellModularChair(const FOddsWellOddsBucksLedger& Ledger);
ODDSWELL_API const FString& GetOddsWellOneBedroomTierId();
ODDSWELL_API int64 GetOddsWellOneBedroomUpgradePrice();
ODDSWELL_API EOddsWellOddsBucksAppendResult AppendOddsWellOneBedroomUpgradePurchase(FOddsWellOddsBucksLedger& Ledger);
ODDSWELL_API bool OwnsOddsWellOneBedroomUpgrade(const FOddsWellOddsBucksLedger& Ledger);
...
ODDSWELL_API EOddsWellMatchWinnerSettlementDecisionResult DecideOddsWellCanonicalMatchWinnerLossDecisionEvidence(
	...
	FString& OutError);
ODDSWELL_API EOddsWellMatchWinnerLossFinalizationResult FinalizeOddsWellCanonicalMatchWinnerLossEvidence(
	const FOddsWellMatchWinnerOffer& ExactOffer,
	int64 OfferEligibleUnixSeconds,
	bool bQaSlot,
...
ODDSWELL_API bool WriteOddsWellCanonicalMatchWinnerLossReconciliation(bool bQaSlot, FString& OutPath, FString& OutError);
